...
const VARIANTS_KEY = "tys-pos-product-variants";
const ADJUSTMENT_KEY = "tys-pos-adjustments";
...
function getProductVariants() { try { return JSON.parse(localStorage.getItem(VARIANTS_KEY)) || {}; } catch(e) { return {}; } }
function saveProductVariants(value) { localStorage.setItem(VARIANTS_KEY, JSON.stringify(value || {})); }
function getAdjustments() { try { return JSON.parse(localStorage.getItem(ADJUSTMENT_KEY)) || []; } catch(e) { return []; } }
function saveAdjustments(value) { localStorage.setItem(ADJUSTMENT_KEY, JSON.stringify(value || [])); }
